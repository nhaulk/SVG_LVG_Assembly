...
#SBATCH -o "JtoD.%j.out"     # standard output, %j adds job number to output fil$
#SBATCH -e "JtoD.%j.err"     #optional, prints our standard error
...
FASTA="$2"
PREFIX="$3"
NCBI_DATA="/lustre/isaac24/proj/UTK0312/nathaniel.haulk/Dlongi_genomes/LVGandSVG_Juicebox/GCF_034640455.1_iyDiaLong2_genomic.fna"
