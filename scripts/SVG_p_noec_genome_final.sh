...
# Define paths
ASSEMBLY="/lustre/isaac24/proj/UTK0312/nathaniel.haulk/projects/Dlongi_genomes/LVGandSVG_Juicebox/SVG_juicebox_p/SVG_Male.p_ctg_noec.review_kac_07-11-25.assembly.assembly"
PREFIX="SVG_p_noec"
...
OUTPUTDIR="../SVG_p_noec_Clean_Genome"
...
cat ${RAWDATA}/HiC_yahs_p/yahs/SVG_Male.p_ctg_yahsout_noec_scaffolds_final.fa ${RAWDATA}/MT_p_noec/CM067966.1.fasta > ${PREFIX}.fasta
...
cat ${RAWDATA}/Blob_p_noec/SVG_Male.p_ctg_noec_blobblurbout.tsv | grep -v "Arthropoda\|record" | cut -f 1 > ${PREFIX}_blob_contaminants.txt
